...
<table border="1">
		<tr><th>Id</th><th>Cid</th><th>password</th><th>account no</th><th>accont type</th><th>Customer name</th><th>Bank name</th><th>balance</th><th>transection password</th><th>Status</th></tr>
<% 
String ap=request.getParameter("at1");
...
{	
	...
	try
	{
		...
		String query="Select distinct * from customer where  bname='"+k+"'";
